...
check_php_cs_fixer() {
    if ! command -v php-cs-fixer &> /dev/null; then
        echo -e "${RED}php-cs-fixer não está instalado. Por favor, instale-o: https://github.com/FriendsOfPHP/PHP-CS-Fixer${NC}"
        exit 1
    fi
}
...
run_php_cs_fixer() {
    ...
    php-cs-fixer --dry-run -vvv --diff fix --config=.php-cs-fixer.php "$modified_files"
}
