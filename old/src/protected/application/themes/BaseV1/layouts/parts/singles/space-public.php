<div class="widget">
    ...
    <?php if($this->isEditable()): ?>
        <div id="editable-space-status" class="js-editable" data-edit="public" data-type="select" data-value="<?php echo $entity->public ? '1' : '0' ?>"  data-source="[{value: 0, text: '<?php \MapasCulturais\i::esc_attr_e("Publicação restrita - requer autorização para criar eventos");?>'},{value: 1, text:'<?php \MapasCulturais\i::esc_attr_e("Publicação livre - qualquer pessoa pode criar eventos");?>'}]">
