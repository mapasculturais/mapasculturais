...
return [
    ...
    'notifications.seal.toExpire'   =>  (int) env('NOTIFICATIONS_SEAL_EXPIRATION', 0),  // days; desabilitado por padrão pois as notificações de expiração granular são enviadas pelo job NotifySealExpirations
