...
class EvaluationMethodTechnicalTest extends TestCase
{
    ...
    function testQuotaInFirstEvaluationPhase() {
        ...
        $this->opportunityBuilder
                ...
                ->addProponentType(ProponentTypes::PESSOA_FISICA->value)
                ->addProponentType(ProponentTypes::COLETIVO->value)
                ->addProponentType(ProponentTypes::PESSOA_JURIDICA->value)
                ->save()
                ->firstPhase()
