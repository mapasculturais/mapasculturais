...
class AppealTechnicalCorrectionServiceTest extends Abstract\TestCase
{
    ...
    public function testBuildCorrectedDataPreservesUnrecognizedFields(): void
    {
        ...
        $result = $service->buildCorrectedEvaluationData(
            $this->criteria,
    ...
    public function testRejectsRemovedCriterion(): void
    {
        ...
        $service->buildCorrectedEvaluationData(
            $this->criteria,
    ...
    public function testCalculatesConsolidatedPreviewUsingAllSentEvaluations(): void
    {
        ...
        $result = $service->calculateConsolidatedResult($this->criteria, [
    ...
    public function testScorePreviewReappliesExistingPercentageBonusWithoutMutation(): void
    {
        ...
        $preview = $service->calculateScorePreview(17.0, (object) [
            'type' => 'percentage',
            'percentage' => 10,
            'fixed' => 0,
            'roof' => 20,
