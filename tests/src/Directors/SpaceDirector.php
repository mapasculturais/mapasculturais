...
class SpaceDirector extends Director
{
    ...
    function createSpace(?Agent $owner = null, ?int $type = null, bool $fill_requered_properties = true, ?Space $parent = null, bool $save = true, bool $flush = true, $disable_access_control = false, bool $private = false): Space
    {
