...
#[ORM\Table(name: "seal_relation_field", indexes: [
    new ORM\Index(name: "idx_srf_relation", columns: ["seal_relation_id"]),
    new ORM\Index(name: "idx_srf_expiry", columns: ["expiry_date"]),
    new ORM\Index(name: "idx_srf_to_expire", columns: ["seal_relation_id", "expiry_date"]),
])]
