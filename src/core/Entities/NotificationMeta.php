...
#[ORM\Table(name: "notification_meta", indexes: [
    new ORM\Index(name: "notification_meta_owner_idx", columns: ["object_id"]),
    new ORM\Index(name: "notification_meta_owner_key_idx", columns: ["object_id", "key"]),
    new ORM\Index(name: "notification_meta_key_idx", columns: ["key"]),
    new ORM\Index(name: "notification_meta_value_idx", columns: ["value"], flags: ["fulltext"])
])]
#[ORM\Entity(repositoryClass: "MapasCulturais\Repository")]
#[ORM\HasLifecycleCallbacks]
class NotificationMeta extends \MapasCulturais\EntityMetadata {
