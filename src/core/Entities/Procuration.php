...
class Procuration extends \MapasCulturais\Entity{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MapasCulturais\Entities\User", inversedBy="_userProcurations", fetch="LAZY")
     * @ORM\JoinColumns({
     ...
     * @var \MapasCulturais\Entities\User
     *
     * @ORM\ManyToOne(targetEntity="MapasCulturais\Entities\User", inversedBy="_attorneyProcurations", fetch="LAZY")
     * @ORM\JoinColumns({
