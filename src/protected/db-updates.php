...
return [
    ...
    'create seal and relation tables' => function() use ($conn) {
        ...
        $conn->executeQuery("DROP SEQUENCE seal_id_seq;");
        $conn->executeQuery("DROP SEQUENCE seal_relation_id_seq;");
        $conn->executeQuery("DROP SEQUENCE seal_meta_id_seq;");
        $conn->executeQuery("DROP TABLE seal_meta;");
        $conn->executeQuery("DROP TABLE seal_relation;");
        $conn->executeQuery("DROP TABLE seal;");
