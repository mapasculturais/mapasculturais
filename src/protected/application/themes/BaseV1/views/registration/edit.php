...
<article class="main-content registration" ng-controller="ProjectController">
    ...
    <div class="registration-fieldset">
        ...
        <?php if($entity->project->isRegistrationOpen()): ?>
            ...
            <p><p/>
            <div class="widget">
                <p class="alert info"><strong>Debe Salvar antes de Enviar inscripción.</strong>. Si no es posible enviar, se le indicarán los errores con un signo de exclamación en los registros correspondientes. <span class="close"></span></p>
            </div>
