    ...
    <div class="registration-fieldset clearfix">
        ...
        <div class="alignright">
            ...
            <?php elseif($project->canUser('@control')): ?>
                <mc-select classes="{{getStatusSlug(data.registration.status)}}" model="data.registration" data="data.registrationStatusesNames" getter="getRegistrationStatus" setter="setRegistrationStatus"></mc-select>
            <?php endif; ?>
        </div>
    </div>
