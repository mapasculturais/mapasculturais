...
<article class="main-content opportunity" ng-controller="OpportunityController">
    ...
    <div class="tabs-content">
        ...
        <?php $this->part('singles/opportunity-events', ['entity' => $entity]) ?>
...
<div class="sidebar opportunity sidebar-right">
    <?php if($this->controller->action == 'create'): ?>
        <div class="widget">
            <p class="alert info"><?php \MapasCulturais\i::_e("Para adicionar arquivos para download ou links, primeiro é preciso salvar a oportunidade");?>.<span class="close"></span></p>
        </div>
    <?php endif; ?>
