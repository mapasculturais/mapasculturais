            ...
            <div class="ficha-spcultura">
                ...
                <p>
                    <?php if ($this->isEditable() || $entity->shortDescription): ?>
                        <span class="label <?php echo ($entity->isPropertyRequired($entity,"shortDescription") && $editEntity? 'required': '');?>"> <?php \MapasCulturais\i::_e("Descrição curta:");?> <?php if($this->isEditable()){ ?><span data-element='countLength'><?=strlen($entity->shortDescription)?></span> <?php \MapasCulturais\i::_e("de 400:");?></span></span><?php } ?><br>
