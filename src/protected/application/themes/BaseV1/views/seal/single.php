    ...
    <div class="tabs-content">
        ...
        <div id="sobre" class="aba-content">
            <div class="ficha-spcultura">
                <p>
                    <span class="label <?php echo ($entity->isPropertyRequired($entity,"shortDescription") && $this->isEditable() ? 'required': '');?>"><?php \MapasCulturais\i::_e("Descrição curta:");?> <span data-element='countLength'><?php if($this->isEditable()){ ?> <?=strlen($entity->shortDescription)?></span> <?php \MapasCulturais\i::_e("de 400:");?></span></span><br> <?php }?>
