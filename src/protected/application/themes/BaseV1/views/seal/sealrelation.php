...
<article class="main-content seal">
	...
	<?php $this->applyTemplateHook('header-image','after'); ?>
        ...
        <div class="header-content">
			...
			<h2><span class="js-editable" data-edit="name" data-original-title="<?php \MapasCulturais\i::_e("Nome de exibição");?>" data-emptytext="<?php \MapasCulturais\i::_e("Nome de exibição");?>"><a href="<?php echo $app->createUrl('seal', 'single', ['id' => $entity->id])?>"><?php echo $entity->name; ?></a></span></h2>
