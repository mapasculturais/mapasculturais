...
<article class="main-content agent">
                ...
                <div class="servico">
                    ...
                    <?php if($this->isEditable() || $entity->site): ?>
                        ...
                        <?php if($this->isEditable()): ?>
                            <span class="js-editable <?php echo ($entity->isPropertyRequired($entity,"site") && $editEntity? 'required': '');?>" data-edit="site" data-original-title="<?php \MapasCulturais\i::_e("Site");?>" data-emptytext="<?php \MapasCulturais\i::_e("Insira a url de seu site");?>"><?php echo $entity->site; ?></span></p>
                        <?php else: ?>
    ...
    <form class="form-complaint-suggestion hidden" id="formulario">
      ...
      <p>
        <input type="submit" value="<?php \MapasCulturais\i::_e("Enviar Denúncia");?>">
      </p>
    </form>
