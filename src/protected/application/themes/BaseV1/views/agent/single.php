    ...
    <div id="sobre" class="aba-content">
        <div class="ficha-spcultura">
            ...
            <div class="servico">
                ...
                <?php if($this->isEditable()): ?>
                    <p class="privado"><span class="icon lock"></span><span class="label">Nome:</span> <span class="js-editable" data-edit="nomeCompleto" data-original-title="Nome Completo ou Razão Social" data-emptytext="Insira seu nome completo ou razão social"><?php echo $entity->nomeCompleto; ?></span></p>
                    <p class="privado"><span class="icon lock"></span><span class="label">CPF/CNPJ:</span> <span class="js-editable" data-edit="documento" data-original-title="CPF/CNPJ" data-emptytext="Insira o CPF ou CNPJ com pontos, hífens e barras"><?php echo $entity->documento; ?></span></p>
                    <p class="privado"><span class="icon lock"></span><span class="label">Data de Nascimento/Fundação:</span>
                    ...
                    <p class="privado"><span class="icon lock"></span><span class="label">Gênero:</span> <span class="js-editable" data-edit="genero" data-original-title="Gênero" data-emptytext="Selecione o gênero se for pessoa física"><?php echo $entity->genero; ?></span></p>
                    <p class="privado"><span class="icon lock"></span><span class="label">Raça/Cor:</span> <span class="js-editable" data-edit="raca" data-original-title="Raça/cor" data-emptytext="Selecione a raça/cor se for pessoa física"><?php echo $entity->raca; ?></span></p>
                ...
                <?php if($this->isEditable()): ?>
                <p class="privado"><span class="icon lock"></span><span class="label">Telefone 1:</span> <span class="js-editable js-mask-phone" data-edit="telefone1" data-original-title="Telefone Privado" data-emptytext="Insira um telefone que não será exibido publicamente"><?php echo $entity->telefone1; ?></span></p>
                <p class="privado"><span class="icon lock"></span><span class="label">Telefone 2:</span> <span class="js-editable js-mask-phone" data-edit="telefone2" data-original-title="Telefone Privado" data-emptytext="Insira um telefone que não será exibido publicamente"><?php echo $entity->telefone2; ?></span></p>
                <?php endif; ?>
            </div>
            ...
            <?php if ( $this->isEditable() || ($entity->localizacao === 'Pública' && $lat && $lng) ): ?>
                <div class="servico clearfix">
                    ...
                    <div class="infos">
                        <?php if($this->isEditable()): ?>
                            <p class="privado">
                                <span class="icon lock"></span><span class="label">Localização:</span>
