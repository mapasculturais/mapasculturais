    ...
    <div class="box">
        ...
        <div class="clearfix">
            ...
            <div class="estatisticas">
                ...
                <div class="label-das-estatisticas">eventos da <?php $this->dict('site: abbreviation'); ?></div>
            </div>
        </div>
    ...
    <div class="box">
        ...
        <div class="clearfix">
            ...
            <div class="estatisticas">
                ...
                <div class="label-das-estatisticas">agentes da <?php $this->dict('site: abbreviation'); ?></div>
            </div>
        </div>
    ...
    <div class="box">
        ...
        <div class="clearfix">
            ...
            <div class="estatisticas">
                ...
                <div class="label-das-estatisticas">espaços da <?php $this->dict('site: abbreviation'); ?></div>
            </div>
        </div>
    ...
    <div class="box">
        ...
        <div class="clearfix">
            ...
            <div class="estatisticas">
                ...
                <div class="label-das-estatisticas">projetos da <?php $this->dict('site: abbreviation'); ?></div>
            </div>
        </div>
...
<article id="capa-desenvolvedores" class="js-page-menu-item objeto-capa clearfix fundo-roxo">
    <div class="box">
        ...
        <p>
             Existem algumas maneiras de desenvolvedores interagirem com o <?php $this->dict('site: inc_project'); ?>. A primeira é através da nossa <a href="https://github.com/hacklabr/mapasculturais/blob/master/doc/api.md" target="_blank">API</a>. Com ela você pode acessar os dados públicos no nosso banco de dados e utilizá-los para desenvolver aplicações externas. Além disso, o <?php $this->dict('site: inc_project'); ?> é construído a partir do sofware livre <a href="http://institutotim.org.br/project/mapas-culturais/" target="_blank">Mapas Culturais</a>, criado em parceria com o <a href="http://institutotim.org.br" target="_blank">Instituto TIM</a>, e você pode contribuir para o seu desenvolvimento através do <a href="https://github.com/hacklabr/mapasculturais/" target="_blank">GitHub</a>.
        </p>
    </div>
</article>
<nav id="capa-nav">
