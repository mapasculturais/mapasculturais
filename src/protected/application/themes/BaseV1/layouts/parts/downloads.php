...
<?php if ($this->isEditable() || $downloads): ?>
    <div class="widget">
        ...
        <?php if($this->isEditable()): ?>
            <a class="add js-open-editbox hltip" data-target="#editbox-download-file" href="#" title="<?php \MapasCulturais\i::_e("Clique para adicionar arquivo para download");?>"></a>
            <div id="editbox-download-file" class="js-editbox mc-left" title="<?php \MapasCulturais\i::_e("Adicionar Arquivo");?>" data-submit-label="Enviar">
