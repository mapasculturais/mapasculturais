        ...
        <div class="agentes clearfix">
            <div class="avatar" ng-repeat="admin in superAdmins">
                ...
                <div class="descricao-do-agente">
                    ...
                    <div>
                        <a href="#" class="btn btn-danger delete" ng-click="deleteSuperAdmin(admin)">Excluir</a>
                    </div>
                </div>
            </div>
            <div ng-click="editbox.open('add-super-admin', $event)" class="hltip editable editable-empty" title="Adicionar Super Administrador"></div>
        ...
        <div class="agentes clearfix">
            <div class="avatar" ng-repeat="admin in admins">
                ...
                <div class="descricao-do-agente">
                    ...
                    <div>
                        <a href="#" class="btn btn-danger delete" ng-click="deleteAdmin(admin)">Excluir</a>
                    </div>
                </div>
            </div>
            <div ng-click="editbox.open('add-admin', $event)" class="hltip editable editable-empty" title="Adicionar Administrador"></div>
