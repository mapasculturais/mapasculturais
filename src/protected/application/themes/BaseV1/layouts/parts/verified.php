...
<div class="widget widget-verified">
    <a href="#"
       ...
       title="<?php sprintf(\MapasCulturais\i::esc_attr__("Clique para marcar/desmarcar este %s"), $entity->entityTypeLabel());?>."
    ></a>
</div>
<?php elseif($entity->isVerified): ?>
<div class="widget widget-verified">
    <a class="verified-seal hltip active" title="<?php sprintf(\MapasCulturais\i::esc_attr__("Este %s é verificado"), $entity->entityTypeLabel());?>" href="#"></a>
</div>
<?php endif; ?>
