...
<article id="home-subsite" class="js-page-menu-item home-entity clearfix">
    <div class="box">
        ...
        <h4>Encontre <?php $this->dict('entities: subsite') ?> por</h4>
        <ul class="abas clearfix">
            <li class="active"><a href="#subsite-terms">Área de atuação</a></li>
            <li><a href="#subsite-types">Tipo</a></li>
        </ul>
    ...
    <div class="box">
        ...
        <?php endif; ?>
        <a class="btn btn-accent btn-large add" href="<?php echo $app->createUrl('subsite', 'create') ?>">Adicionar <?php $this->dict('entities: subsite') ?></a>
        <a class="btn btn-accent btn-large" href="<?php echo $url_search_subsite ?>">Ver tudo</a>
    </div>
</article>
