<div id="header-search-row" class="clearfix" ng-class="{'sombra':data.global.viewMode !== 'list'}">
    <div id="filter-projects" class="entity-filter clearfix" ng-show="data.global.filterEntity === 'project'">
        <header class="clearfix">
            ...
            Projetos
            <a class="icone icon_adjust-vert" ng-click="toggleFilter = !toggleFilter"></a>
        </header>
        <!--.filter-->
        <form class="form-palavra-chave filter" ng-hide="toggleFilter">
        ...
        <!--.filter-->
        <div class="filter verified-filter" ng-hide="toggleFilter">
