<?php if($this->controller->action === 'create'): ?>
    <span class='js-dialog-disabled' data-message=<?php \MapasCulturais\i::_e('Para subir arquivos você primeiro deve salvar.'); ?> ></span>
<?php else: ?>
...
<form class="js-ajax-upload" style="display:none"
    ...
    <?php if($add_description): ?> <input type="text" name="description[<?php echo $file_group ?>]" placeholder=<?php \MapasCulturais\i::_e("Título");?> /><br /><?php endif; ?>
