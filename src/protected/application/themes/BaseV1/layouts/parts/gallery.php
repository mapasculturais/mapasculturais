        ...
        <?php if($gallery): foreach($gallery as $img): ?>
            <div id="file-<?php echo $img->id ?>" class="image-gallery-item" >
                ...
                <?php if($this->isEditable()): ?>
                    ...
                    <a data-href="<?php echo $img->deleteUrl?>" data-target="#file-<?php echo $img->id ?>" class="btn btn-default delete hltip js-remove-item" data-hltip-classes="hltip-ajuda" title="Excluir"></a>
    ...
    <?php if($this->isEditable()): ?>
        <p class="gallery-footer">
            ...
            <div id="editbox-gallery-image" class="js-editbox mc-top" title="Adicionar Imagem na Galeria">
                <?php $this->ajaxUploader($entity, 'gallery', 'append', 'div.js-gallery', '<div id="file-{{id}}" class="image-gallery-item" ><a href="{{url}}"><img src="{{files.galleryThumb.url}}" /></a> <a data-href="{{deleteUrl}}" data-target="#file-{{id}}" class="btn btn-default delete hltip js-remove-item" data-hltip-classes="hltip-ajuda" title="Excluir"></a></div>', 'galleryThumb')?>
            </div>
        </p>
    <?php endif; ?>
<?php endif; ?>
