...
<?php if ($this->isEditable() || $gallery): ?>
        ...
        <?php if($gallery): foreach($gallery as $img): ?>
            <div id="file-<?php echo $img->id ?>" class="image-gallery-item" >
                ...
                <?php if($this->isEditable()): ?>
                    ...
                    <a data-href="<?php echo $img->deleteUrl?>" data-target="#file-<?php echo $img->id ?>" class="btn btn-default delete hltip js-remove-item" data-hltip-classes="hltip-ajuda" title="<?php \MapasCulturais\i::_e("Excluir");?>"></a>
    ...
    <?php if($this->isEditable()): ?>
        <p class="gallery-footer">
            ...
            <div id="editbox-gallery-image" class="js-editbox mc-top" title="<?php \MapasCulturais\i::_e("Adicionar Imagem na Galeria");?>">
