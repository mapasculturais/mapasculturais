...
<div class="opportunity-claim-box">
    <input class="button-form-opportunity-claim btn-primary" type="button" name="opportunity-claim" value="<?php \MapasCulturais\i::esc_attr_e('Solicitar Recurso'); ?>">
</div>

<form class="form-opportunity-claim js-opportunity-claim-form hidden" ng-controller="OpportunityClaimController">
    <p>
