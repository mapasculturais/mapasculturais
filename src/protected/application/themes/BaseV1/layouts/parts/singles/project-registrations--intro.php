<?php if ($entity->introInscricoes || $this->isEditable()): ?>
    ...
    <div id="intro-das-inscricoes" ng-class="{'registration-fieldset': data.isEditable}">
        ...
        <p class="js-editable" data-edit="introInscricoes" data-original-title="<?php \MapasCulturais\i::_e("Introdução da inscrição");?>" data-emptytext="<?php \MapasCulturais\i::_e("Insira o texto.");?>" data-placeholder="<?php \MapasCulturais\i::_e("Insira o texto.");?>" data-showButtons="bottom" data-placement="bottom"><?php echo $this->isEditable() ? $entity->introInscricoes : nl2br($entity->introInscricoes); ?></p>
    </div>
