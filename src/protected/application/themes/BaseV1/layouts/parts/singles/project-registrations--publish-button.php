<?php if ($entity->canUser('@control')): ?>
    ...
    <?php else: ?>
        <div class="clearfix">
            ...
            <?php else: ?>
                <a id="btn-publish-results" class="btn btn-primary disabled hltip" title="<?php \MapasCulturais\i::_e("Você só pode publicar a lista de aprovados após o término do período de inscrições.");?>"><?php \MapasCulturais\i::_e("Publicar resultados");?></a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
<?php endif; ?>