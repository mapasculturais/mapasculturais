    ...
    <header class="main-content-header">
        <?php $this->part('singles/header-image', ['entity' => $entity]); ?>
            <div class="container-card">
                ...
                <?php endif; ?>
                <div class="widget">
                    <h3 class="label <?php echo ($entity->isPropertyRequired($entity,"shortDescription") && $this->isEditable()? 'required': '');?>"><?php \MapasCulturais\i::_e("Descrição curta:");?> <?php if($this->isEditable()) {?> <span data-element='countLength'><?=strlen($entity->shortDescription)?></span><?php \MapasCulturais\i::_e("/400 Caracteres");?><?php }?></h3>
