<div id="registration-attachments" class="registration-fieldset">
    ...
    <div ng-controller="RegistrationConfigurationsController">
        ...
        <edit-box ng-if="data.entity.canUserModifyRegistrationFields" id="editbox-registration-fields" position="right" title="<?php \MapasCulturais\i::_e("Adicionar campo");?>" cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" submit-label="<?php \MapasCulturais\i::_e("Criar");?>" close-on-cancel='true' on-cancel="closeNewFieldConfigurationEditBox" on-submit="createFieldConfiguration" spinner-condition="data.fieldSpinner">
            ...
            <input type="text" ng-model="data.newFieldConfiguration.title" placeholder="<?php \MapasCulturais\i::_e("Nome do campo");?>"/>
            <textarea ng-model="data.newFieldConfiguration.description" placeholder="<?php \MapasCulturais\i::_e("Descrição do campo");?>"/></textarea>
            <div ng-show="data.fieldsWithOptions.indexOf(data.newFieldConfiguration.fieldType) >= 0">
                <textarea ng-model="data.newFieldConfiguration.fieldOptions" placeholder="<?php \MapasCulturais\i::_e("Opções de seleção");?>" style="min-height: 75px"/></textarea>
            ...
            <div ng-if="data.newFieldConfiguration.fieldType == 'textarea' || data.newFieldConfiguration.fieldType == 'text' ">
                <input type="text" ng-model="data.newFieldConfiguration.maxSize" placeholder="<?php \MapasCulturais\i::_e("Quantidade máxima de caracteres");?>"/>
            </div>
            ...
            <edit-box ng-if="data.entity.canUserModifyRegistrationFields" id="editbox-registration-files" position="right" title="<?php \MapasCulturais\i::_e("Adicionar anexo");?>" cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" submit-label="<?php \MapasCulturais\i::_e("Criar");?>" close-on-cancel='true' on-cancel="closeNewFileConfigurationEditBox" on-submit="createFileConfiguration" spinner-condition="data.uploadSpinner">
                <input type="text" ng-model="data.newFileConfiguration.title" placeholder="<?php \MapasCulturais\i::_e("Nome do anexo");?>"/>
                <textarea ng-model="data.newFileConfiguration.description" placeholder="<?php \MapasCulturais\i::_e("Descrição do anexo");?>"/></textarea>
                    ...
                    <li ng-repeat="field in data.fields" on-repeat-done="init-ajax-uploaders" id="field-{{field.type}}-{{field.id}}" class="attachment-list-item">
                        <div ng-if="field.fieldType !== 'file'">
                            ...
                            <edit-box ng-if="data.entity.canUserModifyRegistrationFields" id="editbox-registration-field-{{field.id}}" position="left" title="<?php \MapasCulturais\i::_e("Editar Campo");?>" cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" submit-label="<?php \MapasCulturais\i::_e("Salvar");?>" close-on-cancel='true' on-cancel="cancelFieldConfigurationEditBox" on-submit="editFieldConfiguration" index="{{$index}}" spinner-condition="data.fieldSpinner">
                                ...
                                <input type="text" ng-model="field.title" placeholder="<?php \MapasCulturais\i::_e("Nome do campo");?>"/>
                                <textarea ng-model="field.description" placeholder="<?php \MapasCulturais\i::_e("Descrição do campo");?>"/></textarea>
                                <div ng-show="data.fieldsWithOptions.indexOf(field.fieldType) >= 0">
                                    <textarea ng-model="field.fieldOptions" placeholder="<?php \MapasCulturais\i::_e("Opções de seleção");?>" style="min-height: 75px"/></textarea>
                                    <p class="registration-help"><?php \MapasCulturais\i::_e("Informe uma opção por linha.");?></p>
                                </div>
                                <div ng-if="field.fieldType == 'textarea' || fild.fieldType == 'text' ">
                                    <input type="text" ng-model="field.maxSize" placeholder="<?php \MapasCulturais\i::_e("Quantidade máxima de caracteres");?>"/>
                                </div>
                                ...
                                <div ng-if="data.entity.canUserModifyRegistrationFields" class="btn-group">
                                    <a ng-click="openFieldConfigurationEditBox(field.id, $index, $event);" class="btn btn-default edit hltip" title="<?php \MapasCulturais\i::_e("editar campo");?>"></a>
                                    <a ng-click="removeFieldConfiguration(field.id, $index)" data-href="{{field.deleteUrl}}" class="btn btn-default delete hltip" title="<?php \MapasCulturais\i::_e("excluir campo");?>"></a>
                                </div>
                            </div>
                            ...
                            <div ng-if="field.fieldType === 'file'">
                                ...
                                <!-- edit-box to edit attachment -->
                                <edit-box ng-if="data.entity.canUserModifyRegistrationFields" id="editbox-registration-files-{{field.id}}" position="left" title="<?php \MapasCulturais\i::_e("Editar Anexo");?>" cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" submit-label="<?php \MapasCulturais\i::_e("Salvar");?>" close-on-cancel='true' on-cancel="cancelFileConfigurationEditBox" on-submit="editFileConfiguration" index="{{$index}}" spinner-condition="data.uploadSpinner">
                                    <input type="text" ng-model="field.title" placeholder="<?php \MapasCulturais\i::_e("Nome do anexo");?>"/>
                                    <textarea ng-model="field.description" placeholder="<?php \MapasCulturais\i::_e("Descrição do anexo");?>"/></textarea>
                                    ...
                                    <div class="file-{{field.template.id}}" ng-if="field.template">
                                        ...
                                        <a ng-if="data.entity.canUserModifyRegistrationFields" class="delete hltip" ng-click="removeFileConfigurationTemplate(field.id, $index)" title="<?php \MapasCulturais\i::_e("Excluir modelo");?>"></a>
                                    </div>
                                    <p ng-if="!data.entity.canUserModifyRegistrationFields">
                                    ...
                                    <edit-box ng-if="data.entity.canUserModifyRegistrationFields" id="editbox-registration-files-template-{{field.id}}" position="top" title="<?php \MapasCulturais\i::_e("Enviar modelo");?>" cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" submit-label="<?php \MapasCulturais\i::_e("Enviar modelo");?>" on-submit="sendFile" close-on-cancel='true' spinner-condition="data.uploadSpinner">
                                        ...
                                        <form class="js-ajax-upload" method="post" data-group="{{uploadFileGroup}}" action="{{getUploadUrl(field.id)}}" enctype="multipart/form-data">
                                            ...
                                            <div ng-if="data.entity.canUserModifyRegistrationFields" class="btn-group">
                                                <a ng-click="openFileConfigurationEditBox(field.id, $index, $event);" class="btn btn-default edit hltip" title="<?php \MapasCulturais\i::_e("editar anexo");?>"></a>
                                                <a ng-if="!field.template" ng-click="openFileConfigurationTemplateEditBox(field.id, $index, $event);" class="btn btn-default send hltip" title="<?php \MapasCulturais\i::_e("enviar modelo");?>" ></a>
                                                <a ng-click="removeFileConfiguration(field.id, $index)" data-href="{{field.deleteUrl}}" class="btn btn-default delete hltip" title="<?php \MapasCulturais\i::_e("excluir anexo");?>"></a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
