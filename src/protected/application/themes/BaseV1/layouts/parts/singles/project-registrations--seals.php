...
<div id="registration-seals" class="registration-fieldset">
	...
	<div class="registration-related-agent-configuration" ng-controller="SealsController">
		...
		<div class="selos-relacionados">
			...
			<div class="widget">
				<div class="selos clearfix">
					<div ng-if="!entity.registrationSeals.owner" ng-click="editbox.open('set-seal-owner', $event)" class="hltip editable editable-empty" title="<?php \MapasCulturais\i::_e("Adicionar selo");?>"></div>
					<edit-box id='set-seal-owner' cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" close-on-cancel='true'>
					...
					<div ng-if="entity.registrationSeals.owner" class="avatar-seal">
		                ...
		                <div align="right">
		                	<a class="btn btn-default edit hltip" ng-click="openEditBox('set-seal-owner', $event)" title="<?php \MapasCulturais\i::_e("Editar");?> {{seals[getArrIndexBySealId(entity.registrationSeals.owner)].name}}"><?php \MapasCulturais\i::_e("Trocar selo");?></a>
		                	<a ng-click="removeSeal('owner')" class="btn btn-default delete hltip" title="<?php \MapasCulturais\i::_e("excluir selo");?>"<?php \MapasCulturais\i::_e("Excluir");?></a>
		                </div>
	            	</div>
				</div>
			</div>
		...
		<div class="selos-relacionados">
			<div class="widget">
				<div class="selos clearfix">
					<div ng-if="!entity.registrationSeals.institution" ng-click="editbox.open('set-seal-institution', $event)" class="hltip editable editable-empty" title="<?php \MapasCulturais\i::_e("Adicionar selo");?>"></div>
					<edit-box id='set-seal-institution' cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" close-on-cancel='true'>
			            <div ng-if="seals.length > 0" class="widget">
					        <div class="selos clearfix">
					...
					<div ng-if="entity.registrationSeals.institution" class="avatar-seal">
		                ...
		                <div align="right">
		                	<a class="btn btn-default edit hltip" ng-click="openEditBox('set-seal-institution', $event)" title="<?php \MapasCulturais\i::_e("Editar");?> {{seals[getArrIndexBySealId(entity.registrationSeals.institution)].name}}"><?php \MapasCulturais\i::_e("Trocar selo");?></a>
		                	<a ng-click="removeSeal('institution')" class="btn btn-default delete hltip" title="<?php \MapasCulturais\i::_e("excluir selo");?>" <?php \MapasCulturais\i::_e("Excluir");?> </a>
		                </div>
	            	</div>
				</div>
			</div>
		...
		<div class="selos-relacionados">
			<div class="widget">
				<div class="selos clearfix">
					<div ng-if="!entity.registrationSeals.collective" ng-click="editbox.open('set-seal-collective', $event)" class="hltip editable editable-empty" title="<?php \MapasCulturais\i::_e("Adicionar selo");?>"></div>
					<edit-box id='set-seal-collective' cancel-label="<?php \MapasCulturais\i::_e("Cancelar");?>" close-on-cancel='true'>
			            <div ng-if="seals.length > 0" class="widget">
					        <div class="selos clearfix">
	            	...
	            	<div ng-if="entity.registrationSeals.collective" class="avatar-seal">
		                ...
		                <div align="right">
		                	<a class="btn btn-default edit hltip" ng-click="openEditBox('set-seal-collective', $event)" title="<?php \MapasCulturais\i::_e("Editar");?> {{seals[getArrIndexBySealId(entity.registrationSeals.collective)].name}}"><?php \MapasCulturais\i::_e("Trocar selo");?></a>
		                	<a ng-click="removeSeal('collective')" class="btn btn-default delete hltip" title="<?php \MapasCulturais\i::_e("excluir selo");?>"<?php \MapasCulturais\i::_e("Excluir");?> </a>
		                </div>
	            	</div>
				</div>
			</div>
