...
<?php if ($entity->canUser("viewPrivateData") || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class="servico clearfix">
        ...
        <div class="infos">
            ...
            <?php if($lat){?> <p><span class="label"><?php \MapasCulturais\i::_e("Latitude:");?></span> <span class="lat-txt"><?=$lat?></span></p> <?php } ?>
            <?php if($lng){?><p><span class="label"><?php \MapasCulturais\i::_e("Longitude:");?></span> <span class="lon-txt"><?=$lng?></span></p> <?php } ?>
