...
<?php if ( $this->isEditable() || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class="servico clearfix">
        ...
        <div class="infos">
            ...
            <p><span class="label">Complemento:</span> <span class="js-editable" id="En_Complemento" data-edit="En_Complemento" data-original-title="Complemento" data-emptytext="Agregue un complemento" data-showButtons="bottom"><?php echo $entity->En_Complemento ?></span></p>
            <p><span class="label">Barrio:</span> <span class="js-editable" id="En_Bairro" data-edit="En_Bairro" data-original-title="Barrio" data-emptytext="Agregue el Barrio" data-showButtons="bottom"><?php echo $entity->En_Bairro ?></span></p>
            <p><span class="label">Municipio:</span> <span class="js-editable" id="En_Municipio" data-edit="En_Municipio" data-original-title="Municipio" data-emptytext="Agregue el Municipio" data-showButtons="bottom"><?php echo $entity->En_Municipio ?></span></p>
