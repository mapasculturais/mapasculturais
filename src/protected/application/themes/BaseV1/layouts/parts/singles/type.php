...
<div class="entity-type <?php echo $_entity ?>-type">
    ...
    <a href="#" id="entityType" class='<?php echo $class ?> required' data-original-title="<?php \MapasCulturais\i::esc_attr_e("Tipo");?>" data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Selecione um tipo");?>" data-entity='<?php echo $_entity ?>' data-value='<?php echo $entity->type ?>'>
