...
<div class="entity-type <?php echo $_entity ?>-type">
    ...
    <a href="#" class='<?php echo $class ?> required' data-original-title="<?php \MapasCulturais\i::_e("Tipo");?>" data-emptytext="<?php \MapasCulturais\i::_e("Selecione um tipo");?>" data-entity='<?php echo $_entity ?>' data-value='<?php echo $entity->type ?>'>
