...
<div class="entity-type <?php echo $_entity ?>-type">
    ...
    <a href="#" class='<?php echo $class ?> required' data-original-title="Tipo" data-emptytext="Selecione um tipo" data-entity='<?php echo $_entity ?>' data-value='<?php echo $entity->type ?>'>
