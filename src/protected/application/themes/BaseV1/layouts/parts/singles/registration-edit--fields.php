        ...
        <li ng-repeat="field in data.fields" ng-if="showFieldForCategory(field)" on-repeat-done="registration-fields" class="attachment-list-item registration-edit-mode attachment-list-item-type-{{field.fieldType}}">
            <div ng-show="field.fieldType !== 'file'" id="registration-field-{{field.id}}" >
                ...
                <p ng-if="field.fieldType === 'date'">
                    <span class='js-editable-field js-include-editable' id="{{field.fieldName}}" data-yearrange="2000:+25" data-viewformat="dd-mm-yyyy" data-name="{{field.fieldName}}" data-type="date" data-original-title="{{field.title}}" data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Informe");?>" data-value="{{entity[field.fieldName]}}"></span>
                </p>
