...
?>
<div class="widget">
    <h3>Área de actuación</h3>
    <?php if($this->isEditable()): ?>
        <span id="term-area" class="js-editable-taxonomy" data-original-title="Área de actuación" data-emptytext="Seleccione por lo menos un área" data-restrict="true" data-taxonomy="area"><?php echo implode('; ', $entity->terms['area'])?></span>
    <?php else: ?>
        <?php
