            ...
            <li id="video-<?php echo $video->id ?>">
                ...
                <?php if($this->isEditable()): ?>
                    <div class="btn btn-default">
                        <a class="js-open-editbox edit hltip"
                           data-dialog-title="<?php \MapasCulturais\i::_e("Editar Vídeo");?>"
                           data-target="#editbox-videogallery"
                           data-dialog-callback="MapasCulturais.MetalistManager.updateDialog"
                           ...
                           <a class='delete js-metalist-item-delete hltip js-remove-item' data-href='<?php echo $video->deleteUrl ?>' data-target="#video-<?php echo $video->id ?>" data-confirm-messagem="<?php \MapasCulturais\i::_e("Excluir este vídeo?");?>" title='<?php \MapasCulturais\i::_e("Excluir");?>'></a>
                    </div>
                <?php endif; ?>
            </li>
...
<div id="editbox-videogallery" ng-non-bindable class="js-editbox mc-bottom" title="<?php \MapasCulturais\i::_e("Editar Vídeo");?>"
     ...
     data-metalist-title-label="<?php \MapasCulturais\i::_e("Título");?>" data-metalist-value-label="<?php \MapasCulturais\i::_e("Endereço do vídeo (Youtube ou Vimeo)");?>" data-metalist-description-label="<?php \MapasCulturais\i::_e("Descrição");?>">
    <?php if($this->controller->action == 'create'): ?>
        <span class="js-dialog-disabled" data-message="<?php \MapasCulturais\i::_e("Para adicionar vídeos você primeiro deve salvar.");?>"></span>
    <?php else: ?>
...
<?php if($this->isEditable()): ?>
    <p class="gallery-footer" ng-non-bindable>
        <a class="btn btn-default add js-open-editbox" href="#"
           data-dialog-title="<?php \MapasCulturais\i::_e("Adicionar Vídeo");?>"
           data-target="#editbox-videogallery"
           data-dialog-callback="MapasCulturais.MetalistManager.updateDialog"
