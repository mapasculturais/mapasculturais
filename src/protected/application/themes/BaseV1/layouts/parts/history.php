...
<div class="widget">
    ...
    <ul class="widget-list js-slimScroll">
        <li id="revision-<?php echo $revision->id?>" class="widget-list-item" >
            <a class="js-metalist-item-display" href="<?php echo $app->createUrl("entityRevision","history",[$revision->id])?>"><span><?php echo $revision->message?> [<?php echo $entity->createTimestamp->format('d/m/Y H:i:s');?>]</span></a>
        </li>
    </ul>
	<?php endforeach;?>
</div>
