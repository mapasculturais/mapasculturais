        ...
        <div class="controles">
            ...
            <?php if($entity->usesDraft()): ?>
                <?php if($entity->isNew() || $entity->status <= 0):  ?>
                    <a class="btn btn-primary js-submit-button" data-status="<?php echo $status_draft ?>">Salvar</a>
                    <a class="btn btn-primary js-submit-button" data-status="<?php echo $status_enabled ?>">Publicar</a>
                <?php else: ?>
