...
<?php if ($this->isEditable() || $entity->twitter || $entity->facebook || $entity->googleplus): ?>
    <div class="widget">
        ...
        <a class="icon twitter js-editable" data-edit="twitter" data-notext="true" data-original-title="Perfil no Twitter"
        ...
        <a class="icon facebook js-editable" data-edit="facebook" data-notext="true" data-original-title="Perfil no Facebook"
        ...
        <a class="icon googleplus js-editable" data-edit="googleplus" data-notext="true" data-original-title="Perfil no Google Plus"
