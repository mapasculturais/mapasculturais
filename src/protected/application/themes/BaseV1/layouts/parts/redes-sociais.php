...
<?php if ($this->isEditable() || $entity->twitter || $entity->facebook || $entity->googleplus): ?>
    <div class="widget">
        ...
        <a class="icon icon-twitter js-editable" data-edit="twitter" data-notext="true" data-original-title="Perfil de Twitter"
        ...
        <a class="icon icon-facebook js-editable" data-edit="facebook" data-notext="true" data-original-title="Perfil de Facebook"
        ...
        <a class="icon icon-googleplus js-editable" data-edit="googleplus" data-notext="true" data-original-title="Perfil de Google Plus"
