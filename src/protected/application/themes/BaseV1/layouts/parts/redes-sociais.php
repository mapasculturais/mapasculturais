...
<?php if ($this->isEditable() || $entity->twitter || $entity->facebook || $entity->googleplus): ?>
    <div class="widget">
        ...
        <a class="icon icon-twitter js-editable" data-edit="twitter" data-notext="true" data-original-title="<?php \MapasCulturais\i::_e("Perfil no Twitter");?>"
        ...
        <a class="icon icon-facebook js-editable" data-edit="facebook" data-notext="true" data-original-title="<?php \MapasCulturais\i::_e("Perfil no Facebook");?>"
        ...
        <a class="icon icon-googleplus js-editable" data-edit="googleplus" data-notext="true" data-original-title="<?php \MapasCulturais\i::_e("Perfil no Google Plus");?>"
