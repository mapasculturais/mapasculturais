            ...
            angular.element(window).load(function() {
                ...
                map.on('locationfound', function(e) {
                    ...
                    var marker = L.marker(e.latlng).addTo(map)
                        .bindPopup("Segundo seu navegador, você está aproximadamente neste ponto com margem de erro de " + radius.toString().replace('.',',') + " metros. Buscando resultados dentro de um raio de 1000 metros deste ponto. <a href='#' onclick='document.querySelector(\".leaflet-draw-draw-circle\").click()'>Modificar</a>")
                        .openPopup();
