...
<article id="capa-eventos" class="js-page-menu-item objeto-capa clearfix fundo-verde">
    <div class="box">
		...
		<div class="clearfix">
			<div class="estatisticas">
				<div class="estatistica">0000</div>
		...
		<ul class="abas clearfix">
			<li class="active"><a href="#">Linguagem</a></li>
		</ul>
		<div class="tags">
			<a class="tag" href="#">filtro</a>
			<a class="tag" href="#">filtro</a>
			<a class="tag" href="#">filtro</a>
			<a class="tag" href="#">filtro</a>
			<a class="tag" href="#">filtro</a>
    ...
    <div class="box">
		...
		<a class="botao-grande adicionar" href="#">Adicionar Eventos</a>
    </div>
</article>
<article id="capa-agentes" class="js-page-menu-item objeto-capa clearfix fundo-azul">
    <div class="box">
		...
		<ul class="abas clearfix">
			<li class="active"><a href="#">Área de atuação</a></li>
			<li><a href="#">Tipo</a></li>
		</ul>
		<div class="tags">
			<a class="tag" href="#">filtro</a>
    ...
    <div class="box">
		...
		<a class="botao-grande adicionar" href="#">Adicionar Agentes</a>
    </div>
</article>
<article id="capa-espacos" class="js-page-menu-item objeto-capa clearfix fundo-rosa">
    ...
    <div class="box">
		...
		<a class="botao-grande adicionar" href="#">Adicionar Espaços</a>
    </div>
</article>
<article id="capa-projetos" class="js-page-menu-item objeto-capa clearfix fundo-vermelho">
    ...
    <div class="box">
		...
		<a class="botao-grande adicionar" href="#">Adicionar Projetos</a>
	</div>
</article>
