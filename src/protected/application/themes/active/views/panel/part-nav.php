<nav id="nav-do-painel" class="barra-esquerda barra-lateral painel">
    <ul>
        ...
        <li><a <?php if($this->template == 'panel/contracts') echo 'class="active"'; ?> href="<?php echo $app->createUrl('panel', 'contracts') ?>"><span class="icone icon_currency_alt"></span> Meus Contratos</a></li>
    </ul>
</nav>
<!--#nav-do-painel-->
