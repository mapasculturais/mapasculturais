...
na gestão da cultura da cidade: basta criar seu perfil de <a href=\"$url_search_agents\"  rel='noopener noreferrer'>agente cultural</a>. A partir deste
cadastro, fica mais fácil participar dos editais de fomento à cultura da Prefeitura e também
divulgar seus <a href=\"{$url_search_events}\" rel='noopener noreferrer'>eventos</a>, <a href=\"{$url_search_spaces}\" rel='noopener noreferrer'>espaços</a> ou <a href=\"$url_search_projects\" rel='noopener noreferrer'>projetos</a>.",
