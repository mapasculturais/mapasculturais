$(function(){
    if($('#qualification-evaluation-form').length){
        var template = MapasCulturais.TemplateManager.getTemplate('qualification-evaluation-form-template');

        var $container = $('#qualification-evaluation-form--container');
        ...
        $('body').on('click', 'li.js-field, li.registration-list-item', function(){
            ...
            $('.qualification-evaluation-form--field').hide();

            if($field.hasClass('field-shadow')){
                $('#qualification-evaluation-info').slideDown('fast');
                $('.qualification-evaluation-form--field').hide();
                $field.removeClass('field-shadow');
            } else {
                $('#qualification-evaluation-info').slideUp('fast');
