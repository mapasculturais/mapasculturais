<header id="header-inscritos" class="clearfix">
    ...
    <a class="btn btn-default download" href="<?php echo $this->controller->createUrl('curator_report', [$entity->id]); ?>"><?php \MapasCulturais\i::_e("Baixar lista de inscritos");?></a>
</header>
    ...
    <tbody>
        ...
        <tr ng-repeat="reg in data.entity.registrations" id="registration-{{reg.id}}" class="{{getStatusSlug(reg.status)}}" ng-show="showRegistration(reg)" >
            ...
            <td class="registration-status-col">
                    <span >{{getStatusNameById(reg.status)}}</span>
            </td>
        </tr>
    </tbody>
</table>
