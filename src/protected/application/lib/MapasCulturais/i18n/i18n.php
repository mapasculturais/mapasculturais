...
function load_default_textdomain( $locale = null ) {
	...
	$return = load_textdomain( 'default', LANGUAGES_PATH . "/$locale/LC_MESSAGES/messages.mo" );

	// Load Base Theme into default domain
    
	load_textdomain( 'default', THEMES_PATH . "/BaseV1/languages/$locale.mo" );
...
$defaultDomain = "mapasculturais";
bindtextdomain($defaultDomain, APPLICATION_PATH . 'lib/MapasCulturais/i18n/languages'); 
bind_textdomain_codeset($defaultDomain, 'UTF-8');
