...
<div ng-class="{hidden:!data.reportModal}" class="bg-reports-modal" id="reportsModal">
    <div class="reports-modal">
        ...
        <footer>
            ...
            <button class="btn btn-primary next" ng-click="createGraphic()" ng-if="data.graphicData == true && (data.reportData.type == 'pie' || data.reportData.type == 'line')" ng-disabled="!data.reportData.title || !data.reportData.description || !data.reportData.dataDisplayA"><?php i::_e("Gerar gráfico"); ?></button>
            <button class="btn btn-primary next" ng-click="createGraphic()" ng-if="data.graphicData == true && (data.reportData.type == 'bar' || data.reportData.type == 'table')" ng-disabled="!data.reportData.title || !data.reportData.description || !data.reportData.dataDisplayA || !data.reportData.dataDisplayB"><?php i::_e("Gerar gráfico"); ?></button>
        </footer>
