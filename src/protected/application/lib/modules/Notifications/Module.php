...
class Module extends \MapasCulturais\Module{
    ...
    function _init() {
        ...
        $app->hook('template(<<*>>.header-menu-user):before', function() {
            /** @var \MapasCulturais\Theme $this */
            $this->part('notifications/header-notification',['viewport' => 'desktop']);
        });

        // adiciona novo item no menu do usuário
        $app->hook('template(<<*>>.header-menu-user--mobile):begin', function() {
            /** @var \MapasCulturais\Theme $this */
            $this->part('notifications/header-notification',[ 'viewport' => 'mobile']);
        });
