...
<div class="field" :class="[{error: hasErrors}, classes]">
    ...
    <slot name="input" >
        ...
        <mc-input-datepicker-wrapper v-if="is('time') || is('datetime') || is('date')" :id="propId" :entity="entity" :prop="prop" :min-date="min" :max-date="max" :field-type="fieldType"></mc-input-datepicker-wrapper>
