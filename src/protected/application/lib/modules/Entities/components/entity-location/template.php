...
<div :class="classes" class="entity-location grid-12">
    ...
    <div class="col-12" v-if="editable">
        <div class="grid-12">
            ...
            <entity-field v-if="!ibgeEnable" @change="address()" classes="col-12" :entity="entity" prop="En_Estado" label="<?php i::_e('Estado')?>"></entity-field>
            <entity-field v-if="!ibgeEnable" @change="address()" classes="col-12" :entity="entity" prop="En_Municipio" label="<?php i::_e('Município')?>"></entity-field>
        </div>
    </div>
    <div class="col-12" v-if="editable && ibgeEnable">
        <div class="grid-12">
            <div class="field col-6">
                ...
                <select @change="countiesList(); address()" v-model="entity.En_Estado">
            ...
            <div class="field col-6">
                ...
                <select @change="address()" v-model="entity.En_Municipio">
                    <option v-for="county in counties" :value="county.nome">{{county.nome}}</option>
                </select>
            </div>
        </div>
    </div>
