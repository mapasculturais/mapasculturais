        ...
        <div class="grid-12">
            ...
            <div :class="['col-6', 'sm:col-12', 'create-occurrence__section', {'active' : step==3}]">
                ...
                <div class="create-occurrence__section--fields">
                    <label class="create-occurrence__section--fields-field"> <input type="radio" name="frequency" value="once" /> <?= i::_e('uma vez') ?> </label>
                    <label class="create-occurrence__section--fields-field"> <input type="radio" name="frequency" value="weekly" /> <?= i::_e('semanal') ?> </label>
                    <label class="create-occurrence__section--fields-field"> <input type="radio" name="frequency" value="daily" /> <?= i::_e('todos os dias') ?> </label>
                </div>
            </div>
            ...
            <div :class="['col-12', 'create-occurrence__section', {'active' : step==3}]">
                ...
                <div class="create-occurrence__section--fields">
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[0]"> <?= i::_e('Domingo') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[1]"> <?= i::_e('Segunda') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[2]"> <?= i::_e('Terça') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[3]"> <?= i::_e('Quarta') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[4]"> <?= i::_e('Quinta') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[5]"> <?= i::_e('Sexta') ?> </label>
                    <label class="create-occurrence__section--fields-field"><input type="checkbox" name="day[6]"> <?= i::_e('Sabado') ?> </label>
                </div>
            </div>
                    ...
                    <div class="grid-12">
                        <div class="col-12">
                            <div class="create-occurrence__section--fields">
                                ...
                                <label class="create-occurrence__section--fields-field"> <input type="radio" name="free" :value="true" /> <?= i::_e('Sim') ?> </label>
                                <label class="create-occurrence__section--fields-field"> <input type="radio" name="free" :value="false" /> <?= i::_e('Não') ?> </label>
                            </div>
                        </div>
                        <div class="col-6 sm:col-12">
                            <div class="create-occurrence__section--field">
                    ...
                    <div class="grid-12">
                        <div class="col-12">
                            <div class="create-occurrence__section--field">
                                ...
                                <div class="auto-description">
                                    Capoeira no Sangue Estrada da Pirelli, conjunto Beija flor, WE 10, QD 07, 18, Próximo a feira, Marituba, 67105-740, Ananindeua, PA
                        ...
                        <div class="col-12">
                            <div class="create-occurrence__section--field">
                                ...
                                <input type="text" placeholder="<?= i::_e('Preencha aqui o resumo customizado   ') ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <template #actions="modal">
        ...
        <div class="mobile">
            <div class="button-group">
                ...
                <button v-if="step === 5" class="button button--primary" @click="createPublic(modal)"><?php i::_e('Concluir')?></button>
            </div>
        ...
        <div class="desktop">
            <div class="button-group">
                ...
                <button class="button button--primary" @click="createPublic(modal)"><?php i::_e('Inserir ocorrência')?></button>
            </div>
        </div>
