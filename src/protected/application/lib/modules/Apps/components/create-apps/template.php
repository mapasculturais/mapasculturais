...
<modal :title="modalTitle" classes="create-modal" button-label="Criar app" @open="createEntity()" @close="destroyEntity()">
    <template v-if="entity && !entity.id" #default>
        ...
        <div class="create-modal__fields">
            <entity-field :entity="entity" hide-required  :editable="true" label="<?php i::esc_attr_e("Selecione o tipo do aplicativo")?>" prop="type"></entity-field>
