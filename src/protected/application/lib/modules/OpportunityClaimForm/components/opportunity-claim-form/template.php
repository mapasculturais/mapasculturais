...
');
?>
<mc-modal :title="modalTitle" classes="opportunity-claim-form" button-label="<?php i::_e('Discorda do resultado? Abra o formulário de recurso') ?>" button-classes="opportunity-claim-form__buttonlabel" @close="modal.close()">
    <template #default>
