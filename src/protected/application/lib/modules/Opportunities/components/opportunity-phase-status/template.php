...
<mc-card>
    <div :class="[{'grid-12': tab!='registrations'}, 'opportunity-phase-status']">
        ...
        <div :class="[{'col-12':  tab!='registrations' && entity.isFirstPhase}, 'opportunity-phase-status_action--center']">
            ...
            <mc-link v-if="tab=='registrations' && entity.isFirstPhase" :entity="entity" class="opportunity-phase-status_action--button" icon="external" route="registrations" right-icon>
