...
?>
<div class="col-12">
    <div :class="[{'grid-12': !tab=='registration' && phase.isLastPhase}, 'opportunity-phase-publish-config-registration' ]">
        ...
        <div v-if="!phase.publishedRegistrations" :class="[{'opportunity-phase-publish-config-registration__lastphase': phase.isLastPhase}, {'col-12 grid-12': !phase.isLastPhase && tab!='registrations'}, 'notPublished']">
            ...
            <div class="opportunity-phase-publish-config-registration__unpublishedlast">
