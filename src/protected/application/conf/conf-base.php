...
return array(
    ...
    'registration.ownerDefinition' => array(
        ...
        'description' => \MapasCulturais\i::__('Agente individual (pessoa física) com os campos CPF, Data de Nascimento/Fundação, Email Privado, Gênero, Telefone 1, Raça/cor, e Gênero obrigatoriamente preenchidos'),
        'type' => 1,
