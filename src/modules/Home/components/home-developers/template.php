...
<div class="home-developers"> 
    <div class="home-developers__content">
        ...
        <label class="home-developers__content__title"><?= $this->text('title',i::__('Alô desenvolvedores')) ?></label>
        <div class="home-developers__content__description">
        ...
        <div class="home-developers__content__link">
