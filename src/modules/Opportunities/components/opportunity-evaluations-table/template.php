...
<div :class="['opportunity-evaluations-table', 'grid-12', classes]">
    ...
    <template v-if="!isFuture()">
        <div class="col-12">
            <entity-table controller="opportunity" show-index :raw-processor="rawProcessor" :identifier="identifier" endpoint="findEvaluations" type="registration" :headers="headers" :phase="phase" :visible="['agent', 'number', 'result', 'status', 'evaluator', 'coletivo']" :query="query" :limit="100" @clear-filters="clearFilters" @remove-filter="removeFilter($event)" :filtersDictComplement="filtersDictComplement"> 
                <template #title>
