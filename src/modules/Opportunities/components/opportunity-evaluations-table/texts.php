...
return [
    ...
    'ID agente avaliador' => i::__('ID do agente avaliador'),
    'estado' => i::__('Estado'),
    ...
    'Dispensada por selos' => i::__('Dispensada por selos'),
    'isento' => i::__('Isento'),
    'isentoEm' => i::__('Isento em'),
    'as' => i::__('às'),
    'semAgenteTooltip' => i::__('Não foi possível identificar o agente proponente para verificar os selos.'),
    'Todas' => i::__('Todas'),
