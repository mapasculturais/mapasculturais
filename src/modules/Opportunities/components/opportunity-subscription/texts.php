...
return [
    ...
    'selecione agente coletivo' => i::__('Por favor, selecione o agente coletivo vinculado a inscrição'),
    'inscrições abertas' => i::__('Inscrições abertas'),
    'inscrições abertas período' => i::__('De <strong>{startAt}</strong> a <strong>{endAt}</strong> às <strong>{endHour}</strong>'),
    'inscrições irão abrir' => i::__('As inscrições ainda não estão abertas'),
    'inscrições irão abrir período' => i::__('O período de inscrições começará a partir do dia <strong>{startAt}</strong> às <strong>{startHour}</strong>'),
