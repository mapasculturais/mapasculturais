...
<div class="col-12">
    <div class="grid-12 opportunity-phase-publish-date-config">
        ...
        <template v-if="phase.evaluationMethodConfiguration && phase.evaluationMethodConfiguration.type == 'technical' || phase.evaluationMethodConfiguration.type == 'documentary'">
            <div class="col-12">
