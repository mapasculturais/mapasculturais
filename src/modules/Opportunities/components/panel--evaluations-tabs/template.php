...
<mc-tabs>
    ...
    <mc-tab label="<?= i::_e('Avaliações abertas e disponíveis') ?>" slug="openEvaluations" class="panel-evaluations">
        ...
        <mc-entities name="evaluationsList" type="opportunity" endpoint="findEvaluable" :query="query" select="id,name,parent.{name,status},status,registrationFrom,registrationTo,isContinuousFlow,hasEndDate,isReportingPhase">
