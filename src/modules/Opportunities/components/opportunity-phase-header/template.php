...
<div :class="classes" class="grid-12 opportunity-phase-header">
    ...
    <div v-if="dateFrom" class="opportunity-phase-header__date col-2 sm:col-4">
        <h6 class="bold"><?= i::__("Data de início") ?></h6>
        <h4 class="opportunity__color bold">{{ dateFrom }}</h4>
    </div>
    <div v-if="dateTo" class="opportunity-phase-header__date col-2 sm:col-4">
        <h6 class="bold"><?= i::__("Data final") ?></h6>
        <h4 class="opportunity__color bold">{{ dateTo }}</h4>
    </div>
    <div v-if="publishDate" class="opportunity-phase-header__date col-2 sm:col-4">
