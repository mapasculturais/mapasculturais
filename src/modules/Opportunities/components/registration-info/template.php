...
<div v-if="registration.range || registration.proponentType" :class="['registration-info', classes]">
    <div class="registration-info__content">
        <div v-if="registration.range" class="registration-info__data">
            <h5 class="registration-info__data__title semibold"> <?= i::__('Faixa') ?> </h5>
            <h4 class="registration-info__data__info bold">{{registration.range}}</h4>
        </div>

        <div v-if="registration.proponentType" class="registration-info__data">
