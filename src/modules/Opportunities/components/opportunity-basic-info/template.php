    ...
    <mc-card>
        ...
        <template #content>
            ...
            <div class="grid-12">
                ...
                <entity-field :entity="entity" type="checkbox" prop="isContinuousFlow" label="<?php i::esc_attr_e('É um edital de fluxo contínuo?')?>" :autosave="3000" classes="col-12 sm:col-12"></entity-field>
                ...
                <entity-field v-if="lastPhase && !entity?.isContinuousFlow" :entity="lastPhase" prop="publishTimestamp" :autosave="3000" classes="col-6 sm:col-12">
