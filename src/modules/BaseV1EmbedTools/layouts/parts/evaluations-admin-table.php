...
<header id="header-inscritos" class="clearfix">
    ...
    <a href="<?php echo $app->createUrl('opportunity','reportEvaluations', [$entity->id]) ?>" class="btn btn-default alignright download"><?php \MapasCulturais\i::_e('Baixar lista de avaliações') ?></a>
