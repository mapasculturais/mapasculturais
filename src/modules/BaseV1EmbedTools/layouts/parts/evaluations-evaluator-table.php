...
<thead>
    ...
    <tbody>
        ...
        <tr ng-repeat="evaluation in data.evaluations" id="registration-{{evaluation.registration.id}}">
            ...
            <td class="registration-id-col"><a href="<?=$evaluation_url?>{{evaluation.registration.id}}/user:<?=$valuer_id?>" rel='noopener noreferrer' target="_top">{{evaluation.registration.number}}</a></td>
