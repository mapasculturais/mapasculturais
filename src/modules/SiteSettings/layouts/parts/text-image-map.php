...
<div class="text-image-feature w100">
    <div>
        ...
        <div class="grid-12">
            <entity-field :entity="entity" prop="mapTitle" classes="col-12" :maxLength="65"></entity-field>
            <entity-field :entity="entity" prop="mapDescription" classes="col-12" :maxLength="250"></entity-field>
        </div>
    </div>
