...
<fieldset class="colors-customizer">
    ...
    <div class="colors-customizer__content">
        <div class="colors-customizer__previews">
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-primary" :style="{ backgroundColor: subsite.color_primary }"> <mc-icon name="home"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-secondary" :style="{ backgroundColor: subsite.color_secondary}"> <mc-icon name="home"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-seal" :style="{ backgroundColor: subsite.color_seals}"> <mc-icon name="seal"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-agent" :style="{ backgroundColor: subsite.color_agents}"> <mc-icon name="agent-2"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-event" :style="{ backgroundColor: subsite.color_events}"> <mc-icon name="event"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-opportunity" :style="{ backgroundColor: subsite.color_opportunities}"> <mc-icon name="opportunity"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-project" :style="{ backgroundColor: subsite.color_projects}"> <mc-icon name="project"></mc-icon> </span>
            ...
            <label href="javascript:void(0)" class="colors-customizer__preview">
                <span class="colors-customizer__preview-item is-space" :style="{ backgroundColor: subsite.color_spaces}"> <mc-icon name="space"></mc-icon> </span>
