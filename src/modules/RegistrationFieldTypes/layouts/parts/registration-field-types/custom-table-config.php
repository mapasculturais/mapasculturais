...
<div ng-if="field.fieldType === 'custom-table'">
    ...
    <!-- Inicializa o config.columns se não existir -->
    <div ng-init="field.config.columns = field.config.columns || []"></div>
    ...
    <div ng-repeat="column in field.config.columns track by $index" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; border-radius: 4px; background-color: #f9f9f9;">
        <div style="margin-bottom: 10px;">
            <label style="display: block; margin-bottom: 5px;">
                ...
                <input type="text" ng-model="column.name" style="width: 100%; padding: 5px;" placeholder="<?= i::__('Ex: Nome, Quantidade, Valor...') ?>" required>
            </label>
        </div>
        ...
        <div style="margin-bottom: 10px;">
            <label style="display: block; margin-bottom: 5px;">
                ...
                <select ng-model="column.type" style="width: 100%; padding: 5px;">
        ...
        <div style="margin-bottom: 10px;">
            <label style="display: inline-block;">
                <input type="checkbox" ng-model="column.required" ng-true-value="true" ng-false-value="false">
        ...
        <div ng-if="column.type === 'select'" style="margin-bottom: 10px;">
            <label style="display: block; margin-bottom: 5px;">
                ...
                <textarea ng-model="column.options" style="width: 100%; padding: 5px; min-height: 80px;" placeholder="<?= i::__('Digite uma opção por linha') ?>"></textarea>
            </label>
        </div>
        
        <button type="button" ng-click="field.config.columns.splice($index, 1)" class="btn btn-danger" style="margin-top: 10px;">
            <?= i::__('Remover Coluna') ?>
        </button>
    </div>
    
    <button type="button" ng-click="field.config.columns.push({name:'', type:'text', required:false, options:''})" class="btn btn-primary" style="margin-bottom: 20px;">
    ...
    <div style="margin-bottom: 10px;">
        <label style="display: block; margin-bottom: 5px;">
            ...
            <input type="number" ng-model="field.config.maxRows" min="1" style="width: 100px; padding: 5px;" placeholder="10">
            <small style="display: block; color: #666; margin-top: 3px;">
