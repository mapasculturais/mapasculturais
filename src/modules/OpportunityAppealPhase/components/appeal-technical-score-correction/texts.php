...
return [
    ...
    'conflict' => i::__('Outra pessoa alterou este caso. Os dados foram recarregados; revise antes de tentar novamente.'),
    'requiredReason' => i::__('Informe a justificativa da decisão.'),
    'selectEvaluation' => i::__('Selecione ao menos uma avaliação e um critério reconhecido no recurso.'),
];
