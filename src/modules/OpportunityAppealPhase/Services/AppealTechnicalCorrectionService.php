...
{
    private AppealTechnicalCorrectionCalculator $calculator;

    public function __construct(?AppealTechnicalCorrectionCalculator $calculator = null)
    {
        $this->calculator = $calculator ?? new AppealTechnicalCorrectionCalculator();
    }
    ...
    public function saveDraft(Registration $appeal, User $actor, array $payload): array
    {
        ...
        foreach ((array) ($payload['evaluations'] ?? []) as $change) {
            ...
            $built = $this->calculator->buildCorrectedEvaluationData(
                $criteria,
    ...
    private function buildDraftPreview(Registration $source, AppealTechnicalCorrection $draft): array
    {
        ...
        $consolidatedResult = $this->calculator->calculateConsolidatedResult($criteria, $evaluationData);
        return [
            'consolidatedResult' => $consolidatedResult,
            ...$this->calculator->calculateScorePreview(
                $consolidatedResult,
