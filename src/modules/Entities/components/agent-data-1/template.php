...
<div class="col-12 agent-data">
    <template v-if="verifyFields()">
        ...
        <div class="agent-data__fields">
            ...
            <entity-data v-if="entity.emailPublico && !showOnlyPublicData" class="agent-data__fields--field" :entity="entity" prop="emailPublico" label="<?php i::_e("Email Púbico")?>"></entity-data>
        </div>
    </template>
