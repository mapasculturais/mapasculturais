...
<div class="col-12 agent-data">
    <template v-if="verifyFields()">
        ...
        <div class="agent-data__fields">
            <div v-if="entity.nomeCompleto && !showOnlyPublicData" class="agent-data__fields--field">
                <label class="title"><?php i::_e("Nome Completo") ?></label>
                <div class="box">
                    <label class="box__content">{{entity.nomeCompleto}}</label>
                </div>
            </div>
            <div v-if="entity.nomeSocial && !showOnlyPublicData" class="agent-data__fields--field">
                <label class="title"><?php i::_e("Nome Social") ?></label>
                <div class="box">
                    <label class="box__content">{{entity.nomeSocial}}</label>
                </div>
            </div>
            <div v-if="entity.cpf && !showOnlyPublicData" class="agent-data__fields--field">
                <label class="title"><?php i::_e("CPF") ?></label>
                <div class="box">
                    <label class="box__content">{{entity.cpf}}</label>
                </div>
            </div>
            <div v-if="entity.cnpj && !showOnlyPublicData" class="agent-data__fields--field">
            ...
            <div v-if="entity.telefone1 && !showOnlyPublicData" class="agent-data__fields--field">
                <label class="title"><?php i::_e("Telefone Privado 1") ?></label>
                <div class="box">
                    <label class="box__content">{{entity.telefone1}}</label>
                </div>
            </div>
            <div v-if="entity.telefone2 && !showOnlyPublicData" class="agent-data__fields--field">
                <label class="title"><?php i::_e("Telefone Privado 2") ?></label>
                <div class="box">
                    <label class="box__content">{{entity.telefone2}}</label>
                </div>
            </div>
            <div v-if="entity.emailPrivado && !showOnlyPublicData" class="agent-data__fields--field">
