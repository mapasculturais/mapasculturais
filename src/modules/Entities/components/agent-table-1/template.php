...
<div class="agent-table-1">
    <agent-table :agentType="1" :additionalHeaders="additionalHeaders" :extra-query="extraQuery" :visible-columns="visibleColumns" @clear-filters="clearFilters" @remove-filter="removeFilter($event)" :hide-filters="hideFilters">
