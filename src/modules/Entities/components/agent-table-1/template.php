...
<div class="agent-table-1">
    <agent-table :agentType=1 :additionalHeaders="headers" :extraQuery="extraQuery" :visible-columns="visibleColumns" @clear-filters="clearFilters" @remove-filter="removeFilter($event)" :hide-filters="hideFilters">
        <template #filters="{entities}">
            ...
            <mc-multiselect class="col-2" :model="selectedGender" :items="gender" title="<?= i::esc_attr__('Selecione o gênero: ') ?>" @selected="filterByGender(entities)" @removed="filterByGender(entities)" :hide-filter="hideFilters" hide-button>
                <template #default="{popover, setFilter, filter}">
                    <div class="field">
            ...
            <mc-multiselect class="col-2" :model="selectedRace" :items="race" title="<?= i::esc_attr__('Selecione raça/cor: ') ?>" @selected="filterByRace(entities)" @removed="filterByRace(entities)" :hide-filter="hideFilters" hide-button>
                <template #default="{popover, setFilter, filter}">
                    <div class="field">
