...
<div v-if="propExists()" class="field" :class="[{error: hasErrors}, classes]">
    ...
    <slot name="input" >
        ...
        <!-- masked fields -->
        <input v-if="is('cpf')" v-maska data-maska="###.###.###-##" :value="value" :id="propId" :name="prop" type="text" @input="change($event)" @blur="change($event,true)" :readonly="isReadonly" autocomplete="off">
        
        <input v-if="is('cnpj')" v-maska data-maska="##.###.###/####-##" :value="value" :id="propId" :name="prop" type="text" @input="change($event)" @blur="change($event,true)" :readonly="isReadonly" autocomplete="off">
        ...
        <template v-if="is('color')">
            <div class="field__color">
                <div class="field__color-input">
                    <input :value="value" :id="propId" :name="prop" type="color" @input="change($event)" @blur="change($event,true)" autocomplete="off" />
                </div>
            </div>
        </template>
    </slot>
