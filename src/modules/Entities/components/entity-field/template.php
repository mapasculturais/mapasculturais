    ...
    <div class="field__input">
        <slot name="input">
            ...
            <template v-else-if="is('gallery')">
                <entity-gallery :entity="entity" :editable="!readonly && !disabled" class="registration-gallery"></entity-gallery>
            </template>

            <!-- Galeria de Vídeos (MetaList) -->
            <template v-else-if="is('videos')">
                <entity-gallery-video :entity="entity" :editable="!readonly && !disabled" class="registration-videos"></entity-gallery-video>
            </template>

            <!-- Downloads/Anexos (FileGroup) -->
            <template v-else-if="is('downloads')">
                <entity-files-list :entity="entity" group="downloads" :title="fieldDescription || description.label" :editable="!readonly && !disabled" class="registration-downloads"></entity-files-list>
            </template>
