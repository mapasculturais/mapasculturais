...
<div class="entity-field-location">
    <div class="col-12">
        <div class="grid-12">
            ...
            <div class="field col-4" :class="{'entity-field-location--not-error': !hasError('En_CEP')}">
                <label for="cep">
                    <?= i::__('CEP') ?>
                </label>
            ...
            <div class="field col-8" :class="{'entity-field-location--not-error': !hasError('En_Nome_Logradouro')}">
                <label for="logradouro">
                    <?= i::__('Logradouro') ?>
                </label>
                <input @blur="geolocation()" @input="geolocation(10000)" placeholder="<?= i::esc_attr_e('rua, avenida, praça, viaduto, travessa, etc') ?>" id="logradouro" type="text" v-model="addressData.En_Nome_Logradouro" @change="save" />
            </div>

            <div class="field col-6" :class="{'entity-field-location--not-error': !hasError('En_Num')}">
                <label for="num">
                    <?= i::__('Número') ?>
                </label>
            ...
            <div class="field col-6" :class="{'entity-field-location--not-error': !hasError('En_Bairro')}">
                <label for="bairro">
                    <?= i::__('Bairro') ?>
                </label>
            ...
            <div class="field col-12 sm:col-12 entity-field-location--not-error">
            ...
            <div v-if="statesAndCitiesCountryCode != 'BR'" class="field" :class="{'entity-field-location--not-error': !hasError('En_Pais')}">
                <label for="country">
                    <?= i::__('País') ?>
                </label>
            ...
            <div class="field col-6" :class="{'entity-field-location--not-error': !hasError('En_Estado')}">
            ...
            <div v-if="addressData.En_Estado" class="field col-6" :class="{'entity-field-location--not-error': !hasError('En_Municipio')}">
                <label for="field__title">
                    <?= i::__('Cidade') ?>
                </label>
