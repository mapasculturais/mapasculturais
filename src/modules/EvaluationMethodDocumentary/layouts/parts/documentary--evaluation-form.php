    ...
    <div id="evaluatin-field-{{id}}" class="documentary-evaluation-form--field">
        ...
        <p>
            <label class="input-label">
                <input class="autosave" type="radio" name="data[{{id}}][evaluation]" {{#empty}}checked="checked"{{/empty}} value="">
                <em><?php i::_e('Não avaliar')?></em>
            </label><br>
            <label class="input-label">
                <input class="autosave" type="radio" name="data[{{id}}][evaluation]" {{#valid}}checked="checked"{{/valid}} value="<?php echo STATUS_VALID ?>">
                <em><?php i::_e('Válida')?></em>
            </label>
            <label class="input-label">
                <input class="autosave" type="radio" name="data[{{id}}][evaluation]" {{#invalid}}checked="checked"{{/invalid}} value="<?php echo STATUS_INVALID ?>">
        ...
        <label class="textarea-label">
            ...
            <textarea class="textarea-small autosave" rows="2" name="data[{{id}}][obs_items]">{{obs_items}}</textarea>
        </label>
        <label class="textarea-label">
            <?php i::_e('Justificativa / Observações') ?><br>
            <textarea class="autosave" name="data[{{id}}][obs]">{{obs}}</textarea>
        </label>
