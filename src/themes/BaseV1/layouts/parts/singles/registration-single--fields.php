<div ng-if="data.fields.length > 0" id="registration-attachments" class="registration-fieldset">
    ...
    <ul class="attachment-list" ng-controller="RegistrationFieldsController">
        ...
        <li ng-repeat="field in data.fields" data-field-type="{{getFieldType(field)}}" ng-if="showField(field)" id="field_{{::field.id}}" data-field-id="{{::field.id}}" ng-class=" (field.fieldType != 'section') ? 'js-field attachment-list-item registration-view-mode' : 'section-title'">
