...
<?php if ($entity->canUser('remove') && $entity->status !== $status_trash): ?>
    <a href="<?php echo $entity->deleteUrl ?>" class="btn btn-danger js--remove-entity-button"><?php \MapasCulturais\i::_e("Excluir");?></a>
...
<?php elseif ($entity->canUser('undelete') && $entity->status === $status_trash): ?>
    ...
    <?php if($entity->canUser('destroy')): ?>
        <a class="btn btn-danger js--destroy-entity-button" href="<?php echo $entity->destroyUrl; ?>"><?php \MapasCulturais\i::_e("Excluir Definitivamente");?></a>
    <?php endif; ?>
<?php endif; ?>
