        ...
        <mc-header-menu>
            ...
            <template #default>
                ...
                <li>
                    ...
                    <a href="<?= $app->createUrl('site', 'index') ?>" class="mc-header-menu__item home">
                ...
                <li v-if="global.enabledEntities.opportunities">
                    ...
                    <a href="<?= $app->createUrl('search', 'opportunities') ?>" class="mc-header-menu__item opportunity">
                        <span class="icon opportunity__hover__bg"> <mc-icon name="opportunity"></mc-icon> </span>
                ...
                <li v-if="global.enabledEntities.agents">
                    ...
                    <a href="<?= $app->createUrl('search', 'agents') ?>" class="mc-header-menu__item agent">
                ...
                <li v-if="global.enabledEntities.events">
                    ...
                    <a href="<?= $app->createUrl('search', 'events') ?>" class="mc-header-menu__item event">
                ...
                <li v-if="global.enabledEntities.spaces">
                    ...
                    <a href="<?= $app->createUrl('search', 'spaces') ?>" class="mc-header-menu__item space">
                ...
                <li v-if="global.enabledEntities.projects">
                    ...
                    <a href="<?= $app->createUrl('search', 'projects') ?>" class="mc-header-menu__item project">
